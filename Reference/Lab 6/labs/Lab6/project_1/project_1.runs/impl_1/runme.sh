...
HD_PWD='C:/Users/rodri/ECE350/final-project-team-18/Reference/Lab 6/labs/Lab6/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AudioController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AudioController.tcl -notrace
