...
HD_PWD='C:/Users/rodri/ECE350/final-project-team-18/Reference/Lab 6/labs/Lab6/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AudioController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AudioController.tcl
