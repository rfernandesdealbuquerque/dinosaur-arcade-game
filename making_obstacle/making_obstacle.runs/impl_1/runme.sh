...
HD_PWD='C:/Users/rodri/ECE350/final-project-team-18/making_obstacle/making_obstacle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DINO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DINO.tcl -notrace
