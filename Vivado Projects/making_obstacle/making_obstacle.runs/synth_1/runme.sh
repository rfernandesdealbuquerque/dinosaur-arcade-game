...
HD_PWD='C:/Users/rodri/ECE350/final-project-team-18/making_obstacle/making_obstacle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DINO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DINO.tcl
